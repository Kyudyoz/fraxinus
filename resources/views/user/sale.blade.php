...
<div class="container1">
    @if ($purchases->count())
            ...
            <div class="card mb-3" style="max-width: 100%;">
                <div class="row g-0">
                    ...
                    <div class="col-md-9">
                        ...
                        <a href="https://wa.me/{{ $purchase->user->phone }}" class="card-text text-decoration-none text-body-secondary">Buyer : <small class="text-white btn btn-post"> <i class="fa-brands fa-whatsapp"></i> {{ $purchase->user->name }}</small></a>
        ...
        @endforeach
    @else
      <p class="text-center mt-2 mb-4 fs-4 text-dark">No Products Sale</p>
    @endif
